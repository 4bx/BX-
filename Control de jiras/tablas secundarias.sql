...
insert into usuarios values('Cinthya Martinez','1' );
insert into usuarios values('Beatriz Pérez','1' );
insert into usuarios values('Jaqueline Morales','1');
insert into usuarios values('Juan Martinez','1' );
insert into usuarios values('Cintia Ochoa','2' );
insert into usuarios values('Janet Dominguez','1' );
insert into usuarios values('DesarrolloTAS','2' );
insert into usuarios values('Victor Arellanes','1' );
insert into usuarios values('Veronica Angeles','1' );
insert into usuarios values('Benito Gutierrez','2' );
insert into usuarios values('Isis Murguia','1' );
insert into usuarios values('Azucena Gudiño','1' );
insert into usuarios values('Patricio Ovejas','1' );
